...
def test_paragraph_process():
    ictclas = get_ictclas()
    test_str_seg_pos = '法国/nsf 启蒙/vn 思想家/n 孟德斯/nrf 鸠/n 曾/d 说/v 过/uguo ：/wp “/wyz 一切/rz 有/vyou 权力/n ' \
                       ...
                       '获得/v 的/ude1 ，/wd 他/rr 在/p 其/rz 名著/n 《/wkz 社会/n 契约/n 论/v 》/wky 中/f 写道/v ：/wp ' \
...
def test_import_user_dict():
    ...
    # save_the_usr_dic()
    # import_user_dict(filename, overwrite)
...
def test_frq_count():
    test_str_frq = '权力/n/7#的/ude1/7#。/wj/3#”/wyy/3#，/wd/3#是/vshi/3#“/wyz/3#国家/n/2#：/wp/2#让/v/2#法国/nsf/2#有' \
                   '/vyou/2#渡/v/2#其/rz/2#人/n/2#社会/n/2#权利/n/2#思想家/n/2#启蒙/vn/2#一/m/2#契约/n/2#这/rzv/1#条/q/' \
                   '1#千古/n/1#不/d/1#变/v/1#经验/n/1#滥用/v/1#直到/v/1#把/pba/1#用到/v/1#极限/n/1#方可/d/1#休止/vi/1#容' \
                   '易/ad/1#另/rz/1#卢/nr1/1#梭/ng/1#从/p/1#都/d/1#一切/rz/1#论/k/1#观点/n/1#出发/vi/1#认为/v/1#过/uguo' \
                   '/1#公民/n/1#说/v/1#曾/d/1#鸠/n/1#全部/m/1#自然/n/1#孟德斯/nrf/1#而/cc/1#获得/v/1#他/rr/1#在/p/1#名著' \
                   '/n/1#《/wkz/1#论/v/1#》/wky/1#中/f/1#写道/v/1#任何/rz/1#无不/d/1#以/p/1#民众/n/1#（/wkz/1#）/wky/1#' \
                   '与/p/1#公众/n/1#认可/vi/1#作为/p/1#前提/n/1#'
    ictclas = get_ictclas()
...
def test_last_error_msg():
    assert get_ictclas().get_last_error_msg()
